...
@section('container')
        ...
        <div class="card mb-3">
            ...
            <p>
                <small class="text-muted">
                    By. <a href="/posts?author={{ $posts[0]->user->username }}" class="text-decoration-none">{{ $posts[0]->user->name }}</a> in <a
    ...
    @else 
        <p class="text-center fw-bold text-danger">No Post Found..</p>
    @endif
